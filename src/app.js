...
import { getCulinaries, getThumbByIdHandler, addingRev, getReviewById, searchRecipeByName, 
         filterByRegional, getDistinctRegionals, getRecipeByName, getRecipesByRegional, getPictureById } from "./handler.js";
const app = Express();
...
app.get("/", (req, res) => {
    res.send([
    {
        ...
        "GET": {
            ...
            "Get Image by ID": "/pictures/:idPicture",
        },
        "POST": {
...
app.get("/pictures/:idPicture", getPictureById);
